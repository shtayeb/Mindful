...
class Shape27 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get reminderType =>
      columnsByName['reminder_type']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get pausePointSec =>
      columnsByName['pause_point_sec']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get pausePointCooldownMin =>
      columnsByName['pause_point_cooldown_min']! as i1.GeneratedColumn<int>;
}

i1.GeneratedColumn<int> _column_93(String aliasedName) =>
    i1.GeneratedColumn<int>('pause_point_sec', aliasedName, false,
        type: i1.DriftSqlType.int, defaultValue: const Constant(0));
i1.GeneratedColumn<int> _column_94(String aliasedName) =>
    i1.GeneratedColumn<int>('pause_point_cooldown_min', aliasedName, false,
        type: i1.DriftSqlType.int, defaultValue: const Constant(30));
